...
function update(dt){
 if(typeof MAZE!=="undefined"&&MAZE.active){mazeUpdate(dt);return}
 updateWeekFlow(dt);
 gpRoomTick(dt);
...
function draw(){
 if(typeof MAZE!=="undefined"&&MAZE.active){mazeDraw();return}
...
function ui(){
 ...
 if(typeof MAZE!=="undefined"&&MAZE.active){
   const board=document.querySelector("#eventBoardCurrent");
   const phaseEl=document.querySelector("#eventBoardPhase");
   if(board)board.textContent="🧩 Encontre a saída antes dos outros participantes.";
   if(phaseEl){
     const sec=Math.ceil(MAZE.timeLeft);
     phaseEl.textContent=`⏱️ ${Math.floor(sec/60)}:${String(sec%60).padStart(2,"0")} restantes`;
   }
 }
}
...
function beginInteractiveChallenge(type="lider"){
 ...
 const npcScores=pool.filter(p=>!p.human).map(p=>({p,score:realityChallengeScore(p,type)})).sort((a,b)=>b.score-a.score);
 WEEKFLOW.npcResults=npcScores;

 modal("😇 PROVA DO ANJO",
   "Você também participa. Clique no melhor momento para tentar superar os outros.\n\nO vencedor só será definido depois da sua tentativa.",
   ["COMEÇAR MINHA TENTATIVA"],()=>{closeModal();launchPlayerChallenge(type)})
}
...
const MAZE={
 ...
 exitX:768.0,
 exitY:947.2,
 playerScaleX:1024/1536,
 playerScaleY:572/1024,
 peopleState:[],
 npcPaths:new Map(),
 npcThink:new Map()
,
...
,
 ...
 lastUpdateAt:0
,
 navRoutes:[[[624,1136],[648,1136],[672,1136],[680,1152],[696,1160],[720,1160],[736,1168],[760,1168],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1128,576],[1128,552],[1128,528],[1136,512],[1136,488],[1136,464],[1136,440],[1144,424],[1144,400],[1144,376],[1144,352],[1152,336],[1152,312],[1152,288],[1152,264],[1160,248],[1160,224],[1160,200],[1160,176],[1168,160],[1168,136],[1168,112],[1168,88],[1176,80]],[[624,1136],[640,1144],[656,1152],[680,1152],[704,1152],[720,1160],[744,1160],[760,1168],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1128,576],[1136,560],[1136,536],[1136,512],[1136,488],[1144,472],[1144,448],[1144,424],[1144,400],[1152,384],[1152,360],[1152,336],[1152,312],[1160,296],[1160,272],[1160,248],[1160,224],[1168,208],[1168,184],[1168,160],[1168,136],[1176,120],[1176,96],[1176,80]],[[624,1136],[640,1144],[664,1144],[672,1160],[688,1168],[712,1168],[736,1168],[760,1168],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1128,576],[1128,552],[1128,528],[1136,512],[1136,488],[1136,464],[1136,440],[1144,424],[1144,400],[1144,376],[1144,352],[1152,336],[1152,312],[1152,288],[1152,264],[1160,248],[1160,224],[1160,200],[1160,176],[1168,160],[1168,136],[1168,112],[1168,88],[1176,80]],[[624,1136],[640,1144],[664,1144],[688,1144],[704,1152],[728,1152],[752,1152],[760,1168],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1136,584],[1136,560],[1136,536],[1136,512],[1144,496],[1144,472],[1144,448],[1144,424],[1152,408],[1152,384],[1152,360],[1152,336],[1160,320],[1160,296],[1160,272],[1160,248],[1168,232],[1168,208],[1168,184],[1168,160],[1176,144],[1176,120],[1176,96],[1176,80]],[[624,1136],[648,1136],[664,1144],[688,1144],[712,1144],[728,1152],[752,1152],[776,1152],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1128,576],[1128,552],[1136,536],[1136,512],[1136,488],[1136,464],[1144,448],[1144,424],[1144,400],[1144,376],[1152,360],[1152,336],[1152,312],[1152,288],[1160,272],[1160,248],[1160,224],[1160,200],[1168,184],[1168,160],[1168,136],[1168,112],[1176,96],[1176,80]],[[624,1136],[640,1144],[656,1152],[680,1152],[696,1160],[720,1160],[744,1160],[760,1168],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1136,584],[1136,560],[1136,536],[1136,512],[1144,496],[1144,472],[1144,448],[1144,424],[1152,408],[1152,384],[1152,360],[1152,336],[1160,320],[1160,296],[1160,272],[1160,248],[1168,232],[1168,208],[1168,184],[1168,160],[1176,144],[1176,120],[1176,96],[1176,80]],[[624,1136],[640,1144],[664,1144],[680,1152],[704,1152],[720,1160],[744,1160],[768,1160],[784,1168],[808,1168],[832,1168],[856,1168],[880,1168],[904,1168],[928,1168],[952,1168],[976,1168],[1000,1168],[1024,1168],[1048,1168],[1072,1168],[1096,1168],[1120,1168],[1128,1152],[1128,1128],[1128,1104],[1128,1080],[1128,1056],[1128,1032],[1128,1008],[1128,984],[1128,960],[1128,936],[1128,912],[1128,888],[1128,864],[1128,840],[1128,816],[1128,792],[1128,768],[1128,744],[1128,720],[1128,696],[1128,672],[1128,648],[1128,624],[1128,600],[1128,576],[1128,552],[1136,536],[1136,512],[1136,488],[1136,464],[1144,448],[1144,424],[1144,400],[1144,376],[1152,360],[1152,336],[1152,312],[1152,288],[1160,272],[1160,248],[1160,224],[1160,200],[1168,184],[1168,160],[1168,136],[1168,112],[1176,96],[1176,80]]]
};
MAZE.map.src="assets/arena_labirinto.png";
MAZE.mask.src="assets/arena_labirinto_mask.png";
MAZE.map.onload=()=>MAZE.mapReady=true;
MAZE.mask.onload=()=>{
 const c=document.createElement("canvas");
 c.width=MAZE.mask.naturalWidth||1536;
 c.height=MAZE.mask.naturalHeight||1024;
 const g=c.getContext("2d",{willReadFrequently:true});
 g.drawImage(MAZE.mask,0,0,c.width,c.height);
 MAZE.maskData=g.getImageData(0,0,c.width,c.height);
 MAZE.maskCanvas=c;
 MAZE.maskReady=true
};


function mazeWaypointCanvas(i){
 const p=MAZE.raceWaypoints[Math.max(0,Math.min(MAZE.raceWaypoints.length-1,i))];
 return mazeImageToCanvas(p[0],p[1])
}
...
function mazeProgressOf(p){
 ...
 if(!p.human && Array.isArray(p.mazeDynamicRoute) && p.mazeDynamicRoute.length){
   const idx=Math.max(0,Math.min(p.mazeDynamicRoute.length-1,p.mazeDynamicIndex||0));
   const v=idx/Math.max(1,p.mazeDynamicRoute.length-1);
   const old=MAZE.progress.get(p)||0;
   const out=Math.max(old,v);
   MAZE.progress.set(p,out);
   return out
 }

 // Player progression: proximity to the exit plus best previous value.
 ...
 const v=Math.max(0,Math.min(1,1-dist/total));
 const old=MAZE.progress.get(p)||0;
 const out=Math.max(old,v);
 MAZE.progress.set(p,out);
 return out
...
function mazeLeaderboard(){
 ...
 const list=alive.map(p=>{
   ...
   return {
     p,
     finished,
     progress:finished>=0?9999-finished:mazeProgressOf(p)
   }
 }).sort((a,b)=>{
 ...
 MAZE.lastLeaderboard=list;
 return list
}

function mazePlayerPosition(){
 const list=mazeLeaderboard();
 const i=list.findIndex(x=>x.p===me);
 return i>=0?i+1:list.length
}

function mazeNpcSkill(p){
 const trait=realityTrait(p);
 let skill=.78+Math.random()*.20;
 if(trait==="competitivo")skill+=.10;
 if(trait==="estrategista")skill+=.05;
 return Math.min(1.08,skill)
}


function mazeMaskCellFromCanvas(x,y,cell=8){
 const [ix,iy]=mazeCanvasToImage(x,y);
 return [Math.floor(ix/cell),Math.floor(iy/cell)]
}

function mazeCanvasFromMaskCell(cx,cy,cell=8){
 return mazeImageToCanvas(cx*cell+cell*.5,cy*cell+cell*.5)
}

function mazeMaskCellOpen(cx,cy,cell=8){
 if(!MAZE.maskReady||!MAZE.maskData)return false;
 const W=MAZE.maskData.width,H=MAZE.maskData.height,data=MAZE.maskData.data;
 const px=Math.floor(cx*cell+cell*.5);
 const py=Math.floor(cy*cell+cell*.5);
 if(px<0||py<0||px>=W||py>=H)return false;
 return data[(py*W+px)*4]>=128
}

function mazeFindNearestOpenCell(cx,cy,cell=8,maxR=16){
 if(mazeMaskCellOpen(cx,cy,cell))return [cx,cy];

 for(let r=1;r<=maxR;r++){
   for(let dx=-r;dx<=r;dx++){
     for(const dy of [-r,r]){
       if(mazeMaskCellOpen(cx+dx,cy+dy,cell))return [cx+dx,cy+dy]
     }
   }
...
function mazeBuildDynamicRoute(p){
 if(!p||!MAZE.maskReady||!MAZE.maskData)return [];

 const cell=8;
 let [sx,sy]=mazeMaskCellFromCanvas(p.x,p.y,cell);
 let [gx,gy]=mazeMaskCellFromCanvas(C.width*.94,C.height*.08,cell);

 const s=mazeFindNearestOpenCell(sx,sy,cell,20);
 const g=mazeFindNearestOpenCell(gx,gy,cell,20);
 if(!s||!g)return [];
 ...
 while(open.length&&expanded<maxNodes){
   ...
   if(cur.x===gx&&cur.y===gy){
     ...
     // Remove points very close together. Less waypoint jitter.
     const route=[];
     for(let i=0;i<cells.length;i+=3){
       route.push(mazeCanvasFromMaskCell(cells[i][0],cells[i][1],cell))
     }
     const last=cells[cells.length-1];
     const lastCanvas=mazeCanvasFromMaskCell(last[0],last[1],cell);
     if(!route.length||Math.hypot(route[route.length-1][0]-lastCanvas[0],route[route.length-1][1]-lastCanvas[1])>4){
       route.push(lastCanvas)
     }
     return route
   }
   ...
   for(const [dx,dy] of dirs){
     ...
     const nk=key(nx,ny);
     if(closed.has(nk)||!mazeMaskCellOpen(nx,ny,cell))continue;

     const currentG=gscore.get(ck)??1e9;
     const ng=currentG+1;
...
function mazeNpcRepath(p,force=false){
 if(!p)return false;

 const now=performance.now();
 if(!force && p.mazeLastRepath && now-p.mazeLastRepath<700)return false;

 const route=mazeBuildDynamicRoute(p);
 if(route.length>=2){
   p.mazeDynamicRoute=route;
   p.mazeDynamicIndex=0;
   p.mazeLastRepath=now;
   p.mazeStuckTime=0;
   p.mazeLastX=p.x;
   p.mazeLastY=p.y;
   return true
...
function mazeNpcInit(p,index){
 ...
 // Build path after spawn is placed.
 setTimeout(()=>mazeNpcRepath(p,true),0)
}
...
function mazeNpcRace(p,dt){
 ...
 const steps=Math.max(1,Math.ceil(Math.max(Math.abs(mx),Math.abs(my))/1.5));
 const sx=mx/steps,sy=my/steps;

 let moved=false;

 for(let i=0;i<steps;i++){
   if(mazeWalkableCanvas(p.x+sx,p.y,2.8)){
     p.x+=sx;
     moved=true
   }

   if(mazeWalkableCanvas(p.x,p.y+sy,2.8)){
     p.y+=sy;
     moved=true
   }
 }
 ...
 const movedSinceCheck=Math.hypot(p.x-lx,p.y-ly);
 ...
 // If NPC barely moved for 0.8s, calculate a fresh path from current location.
 if(!moved || p.mazeStuckTime>.8){
   p.mazePause=.04+Math.random()*.05;
   mazeNpcRepath(p,true)
 }
...
function mazeFinishParticipant(p){
 if(!p||!MAZE.active||MAZE.finished||p.mazeFinished)return;

 p.mazeFinished=true;

 if(!MAZE.finishOrder.includes(p)){
   MAZE.finishOrder.push(p)
 }

 // A prova termina imediatamente no primeiro colocado.
 if(MAZE.finishOrder.length===1){
   mazeFinish(p)
 }
}
...
function mazeCanvasToImage(x,y){
 return [x*(MAZE.map.naturalWidth||1536)/C.width,y*(MAZE.map.naturalHeight||1024)/C.height]
}
...
function mazeWalkableCanvas(x,y,r=3){
 ...
 const rr=Math.max(1,Math.round(r*(W/C.width)));

 // Smaller footprint prevents tiny mask noise from blocking narrow corridors.
 const samples=[
   [0,0],[rr,0],[-rr,0],[0,rr],[0,-rr],
   [rr*.65,rr*.65],[-rr*.65,rr*.65],[rr*.65,-rr*.65],[-rr*.65,-rr*.65]
 ];

 for(const [ox,oy] of samples){
   const px=Math.max(0,Math.min(W-1,Math.round(ix+ox)));
   const py=Math.max(0,Math.min(H-1,Math.round(iy+oy)));
   if(data[(py*W+px)*4]<128)return false
 }
 return true
}
...
function mazeNearExit(p){
 ...
 const inExitArea=p.x>C.width*.875 && p.y<C.height*.19;
...
function mazeLeave(){
 ...
 people.filter(p=>p&&p.alive!==false&&!p.eliminated).forEach(p=>{
   ...
   if(s){
     ...
     p.path=[];
     p.pathIndex=0;
     p.targetRoom=s.targetRoom;
     p.facing=s.facing||p.facing
   }

   delete p.mazeFinished;
   delete p.mazeWp;
   delete p.mazeSkill;
   ...
   delete p.mazeLastY;
   delete p.mazeLastX;
   delete p.mazeStuckTime;
   delete p.mazeLastRepath;
   delete p.mazeDynamicIndex;
   delete p.mazeDynamicRoute;
   delete p.mazeRoute
 });
...
function mazeFinish(winner){
 ...
 if(winner){
   if(!MAZE.finishOrder.includes(winner))MAZE.finishOrder.push(winner);
   realitySetLeader(winner);

   const elapsed=Math.max(0,MAZE.elapsed);
   const mm=Math.floor(elapsed/60),ss=(elapsed%60).toFixed(1).padStart(4,"0");
   const playerPos=mazePlayerPosition();

   eventLog(`🏆 ${winner.name} encontrou a saída e venceu o Labirinto!`,14);

   const playerLine=winner===me
     ?"\n\n🥳 VOCÊ FOI O PRIMEIRO!"
     :`\n\nVocê estava em ${playerPos}º quando a prova terminou.`;

   modal("🏆 PROVA ENCERRADA",
     `${winner.name} foi o primeiro a alcançar a SAÍDA.\n\n⏱️ Tempo: ${mm}:${ss}\n👑 ${winner.name} é o novo Líder.${playerLine}`,
     ["VOLTAR PARA A CASA"],()=>{
       closeModal();
       mazeLeave();
       setTimeout(()=>beginChallengeAnnouncement("anjo"),7000)
     })
 }else{
   REALITY.leader=null;
   REALITY.immune.clear();
   eventLog("⌛ O tempo acabou. Ninguém encontrou a saída.",14);
   modal("⌛ TEMPO ESGOTADO",
     "Os 4 minutos terminaram e ninguém alcançou a SAÍDA.\n\n🚫 Não haverá Líder nesta rodada.",
     ["VOLTAR PARA A CASA"],()=>{
       closeModal();
       mazeLeave();
       setTimeout(()=>beginChallengeAnnouncement("anjo"),7000)
...
function mazePlayerMove(dx,dy,dt){
 if(!MAZE.active||!MAZE.started||!me||!me.alive||MAZE.finished)return;
 if(!Number.isFinite(dt)||dt<=0)return;

 const speed=112*(keys.shift?1.28:1);
 const len=Math.hypot(dx,dy)||1;
 const mx=dx/len*speed*dt;
 const my=dy/len*speed*dt;

 // Micro-passos: impossível "pular" uma parede em um frame ruim.
 const steps=Math.max(1,Math.ceil(Math.max(Math.abs(mx),Math.abs(my))/1.5));
 const sx=mx/steps,sy=my/steps;
 ...
 for(let i=0;i<steps;i++){
   ...
   if(mazeWalkableCanvas(me.x+sx,me.y,3))me.x+=sx;
   if(mazeWalkableCanvas(me.x,me.y+sy,3))me.y+=sy;

   // Se diagonal travou totalmente, tenta deslizar numa fração menor.
   if(me.x===ox&&me.y===oy){
     if(mazeWalkableCanvas(me.x+sx*.45,me.y,3))me.x+=sx*.45;
     else if(mazeWalkableCanvas(me.x,me.y+sy*.45,3))me.y+=sy*.45
   }
 }
...
function mazeNpcChooseStep(p){
 // NPCs don't know the perfect solution: they sample nearby walkable directions,
 // with a mild bias toward the exit and occasional wrong turns.
 const dirs=[[1,0],[-1,0],[0,1],[0,-1],[.7,.7],[-.7,.7],[.7,-.7],[-.7,-.7]];
 const [ex,ey]=mazeImageToCanvas(MAZE.exitX,MAZE.exitY);
 const options=[];
 for(const [dx,dy] of dirs){
  const nx=p.x+dx*18,ny=p.y+dy*18;
  if(!mazeWalkableCanvas(nx,ny,5))continue;
  const dist=Math.hypot(ex-nx,ey-ny);
  const wrongTurn=Math.random()*130;
  options.push({dx,dy,score:-dist+wrongTurn})
 }
...
function mazeUpdate(dt){
 ...
 if(me&&me.alive&&!me.mazeFinished){
   let dx=0,dy=0;
...
function mazeDraw(){
 ...
 ctx.clearRect(0,0,C.width,C.height);
 if(MAZE.mapReady)ctx.drawImage(MAZE.map,0,0,C.width,C.height);
 else{ctx.fillStyle="#090713";ctx.fillRect(0,0,C.width,C.height)}
 ...
 // Timer
 ctx.save();
 ctx.fillStyle="rgba(5,8,17,.92)";
 ctx.fillRect(C.width/2-88,10,176,40);
 ctx.strokeStyle="rgba(177,89,255,.78)";
 ctx.strokeRect(C.width/2-88,10,176,40);
 ctx.textAlign="center";
 ctx.fillStyle="#fff";
 ctx.font="800 18px system-ui";
 ctx.fillText(`${mm}:${ss}`,C.width/2,36);
 ctx.font="700 8px system-ui";
 ctx.fillStyle="#c9a7ff";
 ctx.fillText("PROVA DO LÍDER • LABIRINTO",C.width/2,18);
 ...
 list.slice(0,3).forEach((x,i)=>{
   ...
   ctx.fillText(`${i+1}º  ${x.p.name}${suffix}`,boxX+8,yy)
 });
 ...
 if(!MAZE.started){
   ...
   const t=mazeCountdownText();
   ctx.textAlign="center";
   ctx.font=t==="JÁ!"?"1000 52px system-ui":"1000 72px system-ui";
   ctx.fillStyle=t==="JÁ!"?"#65f59a":"#fff";
   ctx.shadowColor="#8d5cff";ctx.shadowBlur=20;
   ctx.fillText(t,C.width/2,C.height/2);
   ctx.shadowBlur=0;
   ctx.font="800 11px system-ui";ctx.fillStyle="#d8cfff";
   ctx.fillText("PREPARE-SE",C.width/2,C.height/2+42)
 }

 mazeDrawCollisionDebug();
 ctx.restore();
 return true
}
